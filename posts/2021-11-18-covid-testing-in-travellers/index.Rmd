...
description: "Worthwhile, I think not"
author:
  - name: Jay Brophy
...
The  data below is from [Canada Public Health](https://www.canada.ca/en/public-health/services/diseases/coronavirus-disease-covid-19/testing-screening-contact-tracing/summary-data-travellers.htm) for July  to end of October 2021.    
```{r fig.align='center'}
library(knitr)
