...
fig1a <- ggplot(data.frame(x = c(-13, 1)), aes(x = x)) +
        ...
        labs(title="MOVe-OUT PDF for primary outcome \n(death + hospitalizations)",
...
ggsave("fig1a.png", width = 5, height = 5)
```


<img src="fig1a.png" alt="Alt text" style="height: 500px; width: auto;">
...
[MOVe-OUT](https://www.ncbi.nlm.nih.gov/pubmed/34914868) was published in the NEJM \       
\    
\    
Interestingly, later RCTs comparing molnupiravir tp placebo, [PANORAMIC](https://www.ncbi.nlm.nih.gov/pubmed/36566761)(n > 25000), [MOVe-AHEAD](https://www.ncbi.nlm.nih.gov/pubmed/37690669)(n > 1500), showed no benefit for their primary outcome measures!
