---
title: "Collider stratification (again!)"
...
This confirms the DGM is performing as expected with an increased smoking risk = `r smoke_est` (exp(0.2717)) with 95% CI (`r smoke_CI[1]` to `r smoke_CI[2]`)  Note in this illustrative case, a deterministic model for PCI with non-smokers having higher (non-measured) risk factors has been used. In the real world this world, a probabilistic mnodel would be employed\
 \
...
Using the exact same data generating mechanism, with increased risk with smoking (RR =1.3) for a repeat revascularization procedure, the smoking parameter in the study sample has been reduced to `r smoke_est_sample` (exp(-.1367)) with 95% CI (`r smoke_CI_sample[1]` to `r smoke_CI_sample[2]`) due to collider risk stratification bias \    
