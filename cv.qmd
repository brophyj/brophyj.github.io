...
<i class="fa-brands fa-twitter fa-lg"></i> [\@brophyj](https://twitter.com/brophyj)   <i class="fa-brands fa-github fa-lg"></i> [brophyj](https://github.com/brophyj)   <i class="fa-brands fa-linkedin fa-lg"></i> [brophyj](https://www.linkedin.com/in/brophyj/)   <i class="fa-brands fa-orcid fa-lg"></i> [brophyj](https://orcid.org/0000-0001-8049-6875)   <i class="fa-brands fa-bluesky fa-lg"></i> [brophyj](https://bsky.app/profile/brophyj.bsky.social)   <i class="fa-solid fa-envelope fa-lg"></i> [james.brophy\@mcgill.ca](mailto:james.brophy@mcgill.ca)
